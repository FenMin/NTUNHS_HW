...
<body>
	...
	<br /><br />
	<div>
		<input type="button" style="position: absolute; top: 1%; left: 30%; border-radius:5px; border-color: #ccc;" value="新增資料" onclick="window.location.href='addnote.php'">
		...
		<?php
			try
			{
				...
				{
					echo "<tr align=center bgcolor=\"#FFEECC\">"; 
					echo "<td><H2>".$row["Title"] . "</H2></td>" ;
					echo "<td valign=\"top\" align=\"left\">";
					echo nl2br($row["Description"]) . "</td>";
					echo "<td><a href='modifynote.php?ID=".$row["ID"]."'>修改</a></td>" ;
					echo "<td><a href='removenote.php?ID=".$row["ID"]."'>刪除</a></td></tr>";
				}
			}
