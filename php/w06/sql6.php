...
<body>
		<?php
			...
			// 用SQL語法呼叫exec()
			$query = "SELECT Nickname,DB_Localcode.C_B5 from personal,DB_Localcode where DB_Localcode.C_ID = personal.Live1 and Live1 LIKE '198%' GROUP BY Nickname ORDER BY Nickname DESC";
